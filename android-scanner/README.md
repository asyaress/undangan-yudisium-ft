...
**APK siap pasang (disarankan):** `android-scanner/Yudisium-FT-1.3.3.apk` — tanpa login; area scan besar; sync lebih responsif; tombol back kembali ke daftar event; offline setelah unduh data event.
...
copy app\build\outputs\apk\release\app-release.apk Yudisium-FT-1.3.3.apk
```
